...
public:
	...
	void tesselateCrossTexture(Tile* tt, int data, double x, double y, double z);
	void tesselateStemTexture(Tile* tt, int data, double h, double x, double y, double z);
	void tesselateStemDirTexture(Tile* tt, int data, int dir, double h, double x, double y, double z);
	void tesselateRowTexture(Tile* tt, int data, double x, double y, double z);
    ...
    void renderFaceDown(Tile* tt, double x, double y, double z, int tex);
    void renderFaceUp(Tile* tt, double x, double y, double z, int tex);
    void renderNorth(Tile* tt, double x, double y, double z, int tex);
    void renderSouth(Tile* tt, double x, double y, double z, int tex);
    void renderWest(Tile* tt, double x, double y, double z, int tex);
    void renderEast(Tile* tt, double x, double y, double z, int tex);
...
private:
    double getWaterHeight(int x, int y, int z, const Material* m);
