...
void MobRenderer::render(Entity* e, double x, double y, double z, float rot, float a)
{
	Mob* mob = (Mob*) e;
...
void MobRenderer::setupPosition(Entity* mob, double x, double y, double z) {
...
void MobRenderer::renderName(Mob* mob, double x, double y, double z) {
...
void MobRenderer::renderNameTag(Mob* mob, const std::string& name, double x, double y, double z, int maxDist) {
