...
void PlayerRenderer::setupPosition( Entity* mob, double x, double y, double z ) {
...
void PlayerRenderer::render(Entity* mob_, double x, double y, double z, float rot, float a) {
	Mob* mob = (Mob*) mob_;
