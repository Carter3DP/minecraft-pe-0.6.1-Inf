...
const double ImprovedNoise::lerp( double t, double a, double b )
{
	return a + t * (b - a);
}

const double ImprovedNoise::grad2( int hash, double x, double z )
{
...
const double ImprovedNoise::grad( int hash, double x, double y, double z )
{
	int h = hash & 15; // CONVERT LO 4 BITS OF HASH CODE
