...
/*static*/
void MobSpawner::finalizeMobSettings(Mob* mob, Level* level, double xx, double yy, double zz) {
	// @todo
...
/*static*/
bool MobSpawner::addMob(Level* level, Mob* mob, double xx, double yy, double zz, float yRot, float xRot, bool force)
{
