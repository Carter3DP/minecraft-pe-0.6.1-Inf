...
public:
    ...
    virtual void addParticle(const std::string& name, double x, double y, double z, double xa, double ya, double za, int data) {}
	virtual void addParticle(ParticleType::Id name, double x, double y, double z, double xa, double ya, double za, int data) {}

	virtual void playSound(const std::string& name, double x, double y, double z, float volume, float pitch) {}
    virtual void playMusic(const std::string& name, double x, double y, double z, float songOffset) {}
