...
public:
	...
	void explode(Entity* source, double x, double y, double z, float r);
	void explode(Entity* source, double x, double y, double z, float r, bool fire);
	...
	Player* getNearestPlayer(double x, double y, double z, float maxDist);
	...
	void addParticle(const std::string& id, double x, double y, double z, double xd, double yd, double zd, int data = 0);
	void addParticle(ParticleType::Id id, double x, double y, double z, double xd, double yd, double zd, int data = 0);
