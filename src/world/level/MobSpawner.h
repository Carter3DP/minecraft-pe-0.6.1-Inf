...
public:
    ...
    static void finalizeMobSettings(Mob* mob, Level* level, double xx, double yy, double zz);
	...
	static bool addMob(Level* level, Mob* mob, double x, double y, double z, float yRot, float xRot, bool force);
