...
public:
	...
	virtual void moveRelative(double xa, double za, float speed);
	...
	virtual bool intersects(double x0, double y0, double z0, double x1, double y1, double z1);
    virtual bool isFree(double xa, double ya, double za, double grow);
    virtual bool isFree(double xa, double ya, double za);
